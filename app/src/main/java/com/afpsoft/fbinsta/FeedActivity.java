        ...
        newReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               for (DataSnapshot ds : dataSnapshot.getChildren()) {
                   ...
                   useremailsFromFB.add(hasMap.get("useremail"));
                   userImageFromFB.add(hasMap.get("downloadurl"));
                   usercommentFromFB.add(hasMap.get("comment"));
                   adapter.notifyDataSetChanged();

                   System.out.println("useremailsFromFB" + useremailsFromFB);
                   System.out.println("userImageFromFB" + userImageFromFB);
                   System.out.println("usercommentFromFB" + usercommentFromFB);
